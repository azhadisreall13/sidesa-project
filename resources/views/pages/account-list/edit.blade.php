                ...
                <form action="/resident/{{ $resident->id }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address', $resident->address) }}">
                            @error('address')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control @error('marital_status') is-invalid @enderror">
                                ...
                                <option value="Belum Menikah" {{ old('marital_status', $resident->marital_status) == 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah</option>
                                <option value="Menikah" {{ old('marital_status', $resident->marital_status) == 'Menikah' ? 'selected' : '' }}>Menikah</option>
                                <option value="Cerai" {{ old('marital_status', $resident->marital_status) == 'Cerai' ? 'selected' : '' }}>Cerai</option>
                                <option value="Duda/Janda" {{ old('marital_status', $resident->marital_status) == 'Duda/Janda' ? 'selected' : '' }}>Janda/Duda</option>
                            </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" value="{{ old('status', $resident->status) }}">
